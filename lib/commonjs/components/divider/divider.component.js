...
const Divider = incomingProps => {
  ...
  const props = (0, _useDefaultProps.useDefaultProps)('Divider', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {
  ...
  const computedStyle = (0, _divider.getStyle)(theme, props);
