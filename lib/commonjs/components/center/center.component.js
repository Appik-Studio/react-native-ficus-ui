...
var _center = require("./center.style");
...
const Center = incomingProps => {
  ...
  const props = (0, _useDefaultProps.useDefaultProps)('Center', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {
    bg: 'transparent',
  ...
  const computedStyle = (0, _center.getStyle)(theme, props);
