...
var _scrollbox = require("./scrollbox.style");
...
const ScrollBox = incomingProps => {
  ...
  const props = (0, _useDefaultProps.useDefaultProps)('ScrollBox', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {
    bg: 'transparent',
  ...
  const computedStyle = (0, _scrollbox.getStyle)(theme, props);
