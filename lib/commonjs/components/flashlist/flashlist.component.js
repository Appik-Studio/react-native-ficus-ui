...
var _flashlist = require("./flashlist.style");
...
const FlashList = incomingProps => {
  ...
  const props = (0, _useDefaultProps.useDefaultProps)('FlashList', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {
    flex: 1
  });
  const {
    bg,
  ...
  const computedStyle = (0, _flashlist.getStyle)(theme, props);
  return /*#__PURE__*/React.createElement(_reactNative.View, {
    style: computedStyle.list
  }, /*#__PURE__*/React.createElement(_flashList.FlashList, rest));
};
