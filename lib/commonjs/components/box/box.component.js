...
const Box = incomingProps => {
  ...
  const props = (0, _useDefaultProps.useDefaultProps)('Box', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {
    bg: 'transparent',
  ...
  const computedStyle = (0, _box.getStyle)(theme, props);
  ...
  const Component = as || _reactNative.View;
