...
var _pressable = require("./pressable.style");
...
const Pressable = incomingProps => {
  ...
  const props = (0, _useDefaultProps.useDefaultProps)('Pressable', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {});
  const {
    bg,
    h,
    w,
  ...
  const computedStyle = (0, _pressable.getStyle)(theme, props);
