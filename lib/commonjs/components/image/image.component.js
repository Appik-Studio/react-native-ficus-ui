...
const Image = incomingProps => {
  const {
    theme,
    windowWidth
  } = (0, _theme.useTheme)();
  const props = (0, _useDefaultProps.useDefaultProps)('Image', (0, _types.handleResponsiveProps)(incomingProps, theme, windowWidth), {});
  const {
    bg,
    h,
    w,
  ...
  const computedStyle = (0, _image.getStyle)(theme, props);
