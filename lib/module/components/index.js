...
export { AvatarProps, AvatarGroupProps, AvatarBadgeProps } from './avatar/avatar.type';
...
export { TabListProps, TabPanelProps, TabProps, TabsProps, TabPanelsProps } from './tabs/tabs.type';
